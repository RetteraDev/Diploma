...
* U. Удобство использования
    * Система должна обучить нового игрока игровому процессу, показать основные механики, взаимодействие с интерфейсом пошагово
    * Визуальные элементы системы должны соответствовать общему визуальному стилю приложения
...
* R. Надежность
    * Сервер приложения должен уметь поддерживать целостность данных в репликах баз данных
    * Приложение должно быть доступно 24 часа в сутки, 7 дней в неделю
