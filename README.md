...
1. Подготовка к игре
    ...
    - Система должна предоставлять возможность новым пользователям редактировать информацию о игровом аватаре бесплатно (установка никнейма, настройка внешнего вида персонажа)
    - (Удобство использования) Система должна обучить нового игрока игровому процессу, показать основные механики, взаимодействие с интерфейсом пошагово
2. Настройка профиля
    - Система должна предоставлять возможность всем пользователям редактировать информацию о игровом аватаре за внутриигровую валюту (установка никнейма, настройка внешнего вида персонажа)
    - Система должна иметь возможность установить медицинские противопоказания игрока. В зависимости от указанных противопоказаний система должна показывать предупреждения о необходимости принять указанные лекарства, сделать специфичные действия
3. Игровой процесс
    ...
    - Система должна предоставить каждому игроку список доступных наград, выделенных заказчиком в рамках договора или гранта
4. Геолокация
    ...
    - (Безопасность) Система должна уметь определять нечестных игроков, использующих для перемещения транспортное средство или VPN

## Нефункциональные требования

1. (Сопровождаемость) Приложение должно поддерживать устройства, работающие на операционных системах:
    - iOS 9.0- 16.0
    - Android 7.0 – 12.0 (учитывая специфические особенности марок Xiaomi, Sony, Huawei)
2. (Производительность) Пользователь, находясь в сети 3G, должен изменения в перемещении по карте с использованием геолокации не более чем за 2 секунды
3. (Безопасность) Приложение должно взаимодействовать с сервером посредством протокола TLS/SSL
4. (Надежность) Сервер приложения должен уметь горизонтально масштабироваться по разным кластерам, взаимодействовать с репликами баз данных и поддерживать целостность данных
